# Mon application pour liste de naissance
...
- Faire un tri côté serveur
- Pré-remplir le nom de l'enseigne à partir de l'url de la boutique
- Mettre a jour l article isBooked quand on réserve
- Faire le bouton pour annuler la réservation
- Demander l'email de réservation pour confirmer
- Ajouter regle unicité sur l'id article dans la table reservation 
